                  ...
                  {showUserMenu && (
                    <div className="absolute right-0 mt-2 w-56 bg-surface border border-border rounded-lg shadow-lg py-2">
                      ...
                      <Link
                        ...
                        className="w-full px-4 py-2 text-left text-sm text-text-secondary hover:text-text-primary hover:bg-muted transition-colors flex items-center gap-2"
                      >
                      ...
                      <button
                        ...
                        className="w-full px-4 py-2 text-left text-sm text-text-secondary hover:text-error hover:bg-muted transition-colors flex items-center gap-2"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
